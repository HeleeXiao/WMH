...
$(document).ready(function(){
    ...
    $(".slide#first").backstretch("/TransverseDynamicPage/images/bg1.jpg");
    $(".slide#sec").backstretch("/TransverseDynamicPage/images/bg2.jpg");
    $(".slide#thirth").backstretch("/TransverseDynamicPage/images/bg4.jpg");
    $(".slide#fourth").backstretch("/TransverseDynamicPage/images/bg5.jpg");
